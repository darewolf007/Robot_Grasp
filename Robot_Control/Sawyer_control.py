...
class Sawyer_control(Base_control):
    def __init__(self):
        ...
        self.joint_name_key = ['right_j0','right_j1','right_j2','right_j3','right_j4','right_j5','right_j6']
    ...
    def open_robot_gripper(self, interval_time = 0.2):
        gripper = intera_interface.Gripper(self.arm_name+ "_gripper", CHECK_VERSION)
